...
This is my home page. My name is Axel Mendez and I am a student at Cal State Fullerton and my major is Computer Science.

## Computer Science Projects

My GitHub page is https://github.com/axelmendez21

### CPSC 120

* lab 3
	
	The second part of lab 3 was very interesting to me as there was a lot of math involved 
	that made it pretty complex to understand for me. The code was supposed to find the
	differences in days between 2 dates, given a day, month, and year. This project made me
	realize the importance of functions, as it would be inefficient to write the formula
	every single time we were going to use it, and it helped with debugging the program
	because when the program didn't output the expected results, I knew it was probably 
...
* lab 8
	...
	when me and my partner got it all correct. This lab was just satisfying in general
